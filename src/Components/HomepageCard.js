...
const HomepageCard = ({ title, icon, link }) => {
    ...
    return (
        <div className="uk-grid-margin">
            <Link className="uk-card uk-card-default uk-card-hover uk-card-body  uk-visible-toggle " tabIndex={0} style={{ height: '250px' }} to={link}>
